...
def run_quantum_visuals():
    ...
    **Interactive Element:**  
    ...
    """)
    state1_freq = st.slider("Frequency of Heads", 1, 10, 2)
    state2_freq = st.slider("Frequency of Tails", 1, 10, 4)
    ...
    **Interactive Element:**  
    ...
    """)
    distance = st.slider("Distance Between Particles", 0.0, 0.4, 0.2)
    effect_strength = st.slider("Effect Strength", 0.0, 1.0, 0.5)
    ...
    **Interactive Element:**  
    ...
    """)
    wavelength = st.slider("Wavelength", 1, 10, 2)
    ...
    **Interactive Element:**  
    ...
    """)
    position_uncertainty = st.slider("Position Uncertainty", 0.1, 3.0, 0.5)
    momentum_uncertainty = st.slider("Momentum Uncertainty", 0.1, 3.0, 2.0)
